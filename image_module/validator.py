...
def validate_contact(contact):
    ...
    # Accept the unified schema ("email") and the
    # older image-extraction schema ("email_addresses").
    email_addresses = contact.get("email_addresses", [])

    if not email_addresses and contact.get("email"):
        email_addresses = [contact.get("email")]
